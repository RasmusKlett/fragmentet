...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('events_event', (
            ...
            ('linkname', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('category', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('event_type', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('cast', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('ticket_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('facebook_id', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('events', ['Event'])

        # Adding M2M table for field galleries on 'Event'
        m2m_table_name = db.shorten_name('events_event_galleries')
        ...
        db.create_unique(m2m_table_name, ['event_id', 'gallery_id'])

        # Adding model 'Event_date'
        db.create_table('events_event_date', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Event'])),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('events', ['Event_date'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field galleries on 'Event'
        db.delete_table(db.shorten_name('events_event_galleries'))

        # Deleting model 'Event_date'
        db.delete_table('events_event_date')
    ...
    models = {
        'events.event': {
            ...
            'cast': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'facebook_id': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),

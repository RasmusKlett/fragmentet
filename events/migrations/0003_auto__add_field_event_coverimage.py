...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.coverimage'
        db.add_column('events_event', 'coverimage',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['photologue.Photo'], unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.coverimage'
        db.delete_column('events_event', 'coverimage_id')

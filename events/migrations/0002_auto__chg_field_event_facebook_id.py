...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.facebook_id'
        db.alter_column('events_event', 'facebook_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Event.facebook_id'
        db.alter_column('events_event', 'facebook_id', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
    ...
    models = {
        'events.event': {
            ...
            'facebook_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),

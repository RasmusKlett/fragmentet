...
class Event(models.Model):
    ...
    cast = models.TextField(null=True, blank=True, verbose_name='Medvirkende')
    info = models.TextField(null=True, blank=True, verbose_name='Praktisk info')
    ...
    coverimage = models.OneToOneField(Photo, default=Photo.objects.filter(title='default_cover')[0])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Infotext.title'
        db.add_column('info_infotext', 'title',
                      self.gf('django.db.models.fields.CharField')(default='titel', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Infotext.title'
        db.delete_column('info_infotext', 'title')
